...
mask_arsenal_pressure = (df.team_name == 'Arsenal WFC') & (df.type_name == 'Pass')
df_pass = df.loc[mask_arsenal_pressure, ['x', 'y', 'end_x', 'end_y']]
mask_arsenal_pressure = (df.team_name == 'Arsenal WFC') & (df.type_name == 'Carry')
df_carry = df.loc[mask_arsenal_pressure, ['x', 'y']]
mask_arsenal_pressure = (df.team_name == 'Arsenal WFC') & (df.type_name == 'Shot')
df_shot = df.loc[mask_arsenal_pressure, ['x', 'y']]
mask_arsenal_pressure = (df.team_name == 'Arsenal WFC') & (df.type_name == 'Dribble')
df_dribble = df.loc[mask_arsenal_pressure, ['x', 'y']]
...
x_coords = pd.concat([df_pressure.x, df_pass.x, df_carry.x, df_shot.x, df_dribble.x])
y_coords = pd.concat([df_pressure.y, df_pass.y, df_carry.y, df_shot.y, df_dribble.y])
# plot heatmap
